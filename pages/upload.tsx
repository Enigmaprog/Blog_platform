...
const Upload = () => {
    ...
    const uploadPhoto = async (e1: any) => {
        const selectedFile = e1.target.files[0];
    ...
    const handlePostPhoto = async () => {
        if (caption && description && imageAsset?._id && topic) {
            setSavingPost(true);
    ...
    <div className='flex w-full h-full absolute left-0 top-[60px] lg:top-[70px] mb-10 pt-10 lg:pt-20 bg-[#F8F8F8] justify-center'>
        ...
        <div>
            ...
            <p className='text-md text-gray-400 mt-1'>Post a photo to your account</p>
            </div>
            ...
            <p className='text-center text-xl text-red-400 font-semibold mt-4 w-[260px]'>
                Please select a photo file (jpg or png or jpeg)
            </p>
            )}
        </div>
            <div className='flex flex-col gap-3 pb-50'>
                    ...
                    <input
                        ...
                        className='rounded lg:after:w-850 outline-none text-md border-2 border-gray-200 p-2'/>
                    
                    <label className='Text-md font-medium'>Tell your story ...</label>
                    <textarea 
                        id="w3review" 
                        name="w3review" 
                        rows={4} 
